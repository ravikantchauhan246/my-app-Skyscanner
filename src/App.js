...
const daysOfWeek = [
  ...
  { name: 'Monday', nameAbbr: 'Mon', index: 2, isWeekend: false },
  { name: 'Tuesday', nameAbbr: 'Tue', index: 0, isWeekend: false },
  { name: 'Wednesday', nameAbbr: 'Wed', index: 0, isWeekend: false },
  { name: 'Thursday', nameAbbr: 'Thur', index: 0, isWeekend: false },
  { name: 'Friday', nameAbbr: 'Fri', index: 0, isWeekend: false },
